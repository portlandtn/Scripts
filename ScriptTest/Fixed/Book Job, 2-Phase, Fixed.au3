#cs ----------------------------------------------------------------------------
 ...
 Script Function:
		Books a single project, after it has been created
...
Call("ProjectInfoInput",$WindowTitle,$CurrentJobName,"2Ph")
...
ControlClick($WindowTitle,"","[NAME:lvwSalesSummary]","right",1,180, 138)
Sleep(250)
Send("{DOWN 4}")
Send("{ENTER}")
